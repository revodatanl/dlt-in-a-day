...
CREATE STREAMING LIVE TABLE clickstream_raw COMMENT "The raw wikipedia click stream dataset, ingested from /databricks-datasets." AS
SELECT
  *
FROM
cloud_files("/databricks-datasets/wikipedia-datasets/data-001/clickstream/raw-uncompressed-json/", "json")

-- COMMAND ----------

-- DBTITLE 1,Clean and prepare data
CREATE STREAMING LIVE TABLE clickstream_clean(
...
CREATE MATERIALIZED VIEW top_spark_referers
